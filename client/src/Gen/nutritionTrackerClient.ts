...
/**
 * Instantiates a new {@link NutritionTrackerClient} and sets the default values.
 * @param requestAdapter The request adapter to use to execute the requests.
 */
// @ts-ignore
export function createNutritionTrackerClient(requestAdapter: RequestAdapter) {
    ...
    return apiClientProxifier<NutritionTrackerClient>(requestAdapter, pathParameters, NutritionTrackerClientNavigationMetadata, undefined);
}
/**
 * The main entry point of the SDK, exposes the configuration and the fluent API.
 */
export interface NutritionTrackerClient extends BaseRequestBuilder<NutritionTrackerClient> {
    /**
     * The api property
     */
 ...
 */
export const NutritionTrackerClientUriTemplate = "{+baseurl}";
/**
 * Metadata for all the navigation properties in the request builder.
 */
export const NutritionTrackerClientNavigationMetadata: Record<Exclude<keyof NutritionTrackerClient, KeysToExcludeForNavigationMetadata>, NavigationMetadata> = {
    api: {
